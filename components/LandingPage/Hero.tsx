...
const Hero = async ({ locale }: { locale: Locale }) => {
  ...
  return (
    <div className="absolute w-full  top-0  2xl:-top-28 bg-[url('https://career-at-germany-de.s3.ap-south-1.amazonaws.com/static+images/hero-bg-xl.png')] bg-no-repeat bg-cover">
